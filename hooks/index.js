// Hooks de sincronização em tempo real com Supabase e Firebase
export { useRealtimePhotos } from './useRealtimePhotos';
export { useSupabasePhotos } from './useSupabasePhotos';
