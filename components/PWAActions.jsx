            ...
            <>
              ...
              {!isMobile && (
                <motion.div
                  ...
                  className="absolute bottom-full left-0 mb-4 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 p-3 min-w-[240px]"
                >
